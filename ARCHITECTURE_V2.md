# TurboLoader v2.0 - High-Performance Pipeline Architecture
...
class TarReaderV2 {
public:
    TarReaderV2(const std::string& path);
...
- [ ] TarReaderV2 with per-worker handles
- [ ] Memory-mapped I/O
