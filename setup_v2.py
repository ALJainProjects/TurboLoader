"""
Setup script for TurboLoader v2.0 Python bindings

Builds the turboloader_v2 module using pybind11.
"""
...
ext_modules = [
    Extension(
        'turboloader_v2',
        sources=['src/python/turboloader_v2_bindings.cpp'],
        include_dirs=[
            get_pybind_include(),
            jpeg_include,
...
setup(
    ...
    description='High-performance data loading for PyTorch (v2.0)',
