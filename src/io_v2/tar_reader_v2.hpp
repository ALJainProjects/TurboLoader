...
public:
     ...
     */
    TarReaderV2(const std::string& tar_path, size_t worker_id, size_t num_workers)
        : tar_path_(tar_path),
    ...
    TarReaderV2(const TarReaderV2&) = delete;
    TarReaderV2& operator=(const TarReaderV2&) = delete;
    TarReaderV2(TarReaderV2&&) = delete;
    TarReaderV2& operator=(TarReaderV2&&) = delete;
